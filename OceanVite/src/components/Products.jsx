...
function Products() {
  return (
    <div className="relative">
      <div className="grid grid-cols-4 gap-y-8 gap-x-4 my-12 ">
        ...
        <div className="relative h-[350px] w-[200px] rounded-[10px]">
          ...
          <img
            src="./images/bg.jpg"
            alt="book image"
            className="rounded-tr-[10px] rounded-tl-[10px] h-[270px] w-[200px]"
          />
        ...
        <div className="relative h-[350px] w-[200px] rounded-[10px]">
          ...
          <span className="absolute font-bold text-white bg-pinkColor bottom-0 right-0 w-[70px] p-2">
            Nepali
          </span>
          {/* </div> */}
        </div>
      ...
      <button className="bg-pinkColor p-2 rounded-[5px] text-white font-bold absolute right-0 bottom-5 ">Add Book</button>
    </div>
  );
}
